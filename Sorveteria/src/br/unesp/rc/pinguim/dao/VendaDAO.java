...
/**
 * Interface para persistência de Vendas
 */
public interface VendaDAO {
	...
	public static final String SELECT_VENDA = "SELECT v.codigo,total,dataVenda,Funcionario_codigo,Pagamento_codigo, "
			+ "metodoPagamento, f.nome FROM Venda v " + "JOIN pagamento p on Pagamento_codigo =  p.codigo "
			+ "JOIN funcionario f on f.codigo = v.Funcionario_codigo " + "ORDER BY v.codigo";
